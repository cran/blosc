...
|               |                        |              | `double`. Use with caution           |
+---------------+------------------------+--------------+--------------------------------------+
| `|S*   `      | UTF8 string            | `character()`|                                      |
+---------------+------------------------+--------------+--------------------------------------+
| `|U*`         | UTF32 string           | `character()`| Note that UTF8 encoding is used in   |
|               |                        |              | the conversion process. Hence,       |
|               |                        |              | information may get lost. Use with   |
|               |                        |              | caution                              |
+---------------+------------------------+--------------+--------------------------------------+
...
The examples below show how you can use custom values to represent missing
values.
